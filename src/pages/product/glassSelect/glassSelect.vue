<template>
  <div style="height: 100%">
    ...
    <section style="height: 100%">
      ...
      <div class="trans-bg-60" v-if="menuOpened">

      </div>

      <div class="pop-group-select-layout" v-if="menuOpened">
        <radio-group class="radio-group" @change="radioChange">
          <radio class="radio" v-for="item in groupNameList" :key="item.value" :value="item.value"
                 :checked="item.checked" :color="'#cab894'">
